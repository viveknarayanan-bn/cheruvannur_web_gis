...
map.getView().fit([8413774.839398, 1285719.465977, 8459520.963055, 1307656.641478], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">cheruvannur-web-gis</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (72 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'preparing this work as a part of studies,with the guaidence of adharsa h';
            }
